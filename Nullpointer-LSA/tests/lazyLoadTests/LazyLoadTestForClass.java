...
import mappersClass.PowerToolMapper;
import mappersClass.StripNailMapper;
import sharedDomain.*;
@RunWith(Parameterized.class)
class LazyLoadTestForClass {
	DatabaseManager dbm;
    Savepoint sp;
	...
	@Test
	void testsLazyLoadOnPowerToolSideForClass() throws Exception {
	...
	@Test
	void testsLazyLoadOnStripNailSideForClass() throws Exception {
		MapperManager.getSingleton().setMapperPackageName("mappersClass");
		StripNailMapper sn = new StripNailMapper("111",11, 1,0.1,1);
